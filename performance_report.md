...
### 1. [MonitorScreen:342-385] 每次重组都重绘 Canvas
...
### 3. [PpgAnalyzer:19-20, 37] 遍历记录列表 5 次
...
### 4. [DataScreen:76, 123] 每个文件项 O(n×m) 线性扫描
...
### 10. [MonitorViewModel:173] BLE 响应固定 500ms 延迟
